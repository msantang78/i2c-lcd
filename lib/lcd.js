...
LCD = (function() {
  function LCD(device, address) {
    ...
    this.i2c = i2c.openSync(device);
  }

  LCD.prototype.init = function() {
    this.write4(0x30, displayPorts.CMD);
      
    this.write4(0x30, displayPorts.CMD);

    this.write4(0x30, displayPorts.CMD);

    this.write4(LCD.FUNCTIONSET | LCD._4BITMODE | LCD._2LINE | LCD._5x10DOTS, displayPorts.CMD);

    this.write(LCD.DISPLAYCONTROL | LCD.DISPLAYON, displayPorts.CMD);

    this.write(LCD.ENTRYMODESET | LCD.ENTRYLEFT, displayPorts.CMD);

    //this.write(LCD.CLEARDISPLAY, displayPorts.CMD);
  };
  ...
  LCD.prototype.write4 = function (x, c) {
    ...
    bytes = new Buffer([a | displayPorts.backlight | c, a | displayPorts.E | displayPorts.backlight | c, a | displayPorts.backlight | c]);

    this.i2c.i2cWriteSync (this.address, bytes.length, bytes);
  };
  ...
  LCD.prototype.write = function (x, c) {
    ...
    var data = [a | displayPorts.backlight | c, a | displayPorts.E | displayPorts.backlight | c, a | displayPorts.backlight | c, a2 | displayPorts.backlight | c, a2 | displayPorts.E | displayPorts.backlight | c, a2 | displayPorts.backlight | c]
  ...
  LCD.prototype.clear = function() {
    this.write(LCD.CLEARDISPLAY, displayPorts.CMD);
    // add read to delay return (Fix clear make fail next command) Martin
    this.i2c.readByteSync(this.address, displayPorts.CMD);
    this.i2c.readByteSync(this.address, displayPorts.CMD);
  };
  ...
  LCD.prototype.print = function (str) {
    ...
    for (var i in charCodes) {
      this.write(charCodes[i], displayPorts.CHR);
    }
  };
  ...
  LCD.prototype.setCursor = function(x, y) {
    ...
    this.write(LCD.SETDDRAMADDR | (l[y] + x), displayPorts.CMD);
  };
  ...
  LCD.prototype.createChar = function(ch, data) {
    ...
    this.write(LCD.SETDDRAMADDR, displayPorts.CMD);
  };
